...
const Hero1 = () => {
  return (
    <section>
      <div className="">
        <Image className="w-full h-full object-cover" src="/banner1.jpg" alt="hero1" width={1300} height={500} />
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-7 text-justify text-base mt-3">
                ...
                and recharges groundwater, providing a cost-effective,
                eco-friendly water source for homes, industries, and commercial
