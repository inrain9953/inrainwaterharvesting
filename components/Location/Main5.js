      ...
      <div className='max-w-7xl mx-auto px-4 md:px-8 lg:px-10'>
        ...
        <div className='max-w-3xl mx-auto text-center mb-10'>
          ...
          <p className='text-gray-600 text-base md:text-md   leading-7'>
            ...
            conservation s that aim to address the global water scarcity crisis.
            With a commitment to environmental sustainability and economic
            efficiency, GeoTech Ecosystem offers a range of innovative solutions
            to help individuals, communities, and businesses optimize their
