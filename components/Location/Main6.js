        ...
        <div className='grid lg:grid-cols-2 gap-10 items-center'>
          ...
          <div>
            ...
            <h3 className='text-2xl md:text-4xl font-bold text-gray-900 leading-tight mb-3'>
              ...
              <span className='text-sky-600'> in {location}</span>
            </h3>
            ...
            <div className='space-y-4 text-gray-600 text-base md:text-md leading-7 text-justify'>
              <p>
                ...
                Developers, Central Public Works Department (CPWD), Public Works
            ...
            {/* CTA */}
            <div className='mt-5'>
              <Link href={`/water-harvesting-system/${slug}`}>
                <Button
                  variant='contained'
                  sx={{
                    borderRadius: '14px',
