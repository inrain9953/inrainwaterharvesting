...
const DynamicMetatag = ({ data }) => {
  return (
    <Head>
      ...
      <meta charSet='UTF-8' />
      <meta name='author' content='GeoTech Ecosystem' />
      ...
      <meta rel='canonical' href={data.canonical} />
