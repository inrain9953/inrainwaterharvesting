...
const About = () => {
  const data = {
    title: 'About Us | GeoTech Ecosystem',
    desc: 'Looking for a reliable Rainwater Harvesting System in India? GeoTech Ecosystem provide efficient solutions for sustainable water management and get Rooftop Rainwater Harvesting System in India',
    keyword:
    ...
    ogTitle: 'About Us | GeoTech Ecosystem',
    ogDescription:
      'Looking for a reliable Rainwater Harvesting System in India? GeoTech Ecosystem provide efficient solutions for sustainable water management and get Rooftop Rainwater Harvesting System in India',
    ogUrl: 'https://www.inrainwaterharvesting.com/about',
    twittertitle: 'About Us | GeoTech Ecosystem',
    twitterdescription:
      'Looking for a reliable Rainwater Harvesting System in India? GeoTech Ecosystem provide efficient solutions for sustainable water management and get Rooftop Rainwater Harvesting System in India'
  }
  return (
            ...
            <div>
              ...
              <div className='space-y-5 mt-3 text-slate-600 leading-7 text-md'>
                <p>
                  ...
                  is a leading company specializing in advanced rainwater
                  harvesting solutions. With a strong track record of success,
                  we have executed over{' '}
                  <strong>4000+ Rainwater Harvesting (RWH) units</strong> for
                  esteemed clients such as{' '}
                  <strong>
                    DLF, PepsiCo, HUL, Jaypee, NHAI, Whirlpool, Radisson, CPWD,
                    PWD, Smart Cities, and Supreme Court Judges Bungalows, among
                    others.
                  </strong>{' '}
                  Our commitment to innovation, quality, and sustainability has
                  made us a trusted partner in the industry.
                </p>

                <p>
                  At GeoTech Ecosystem, we offer comprehensive rainwater
                  harvesting solutions that help our clients optimize water
                  resources and promote environmental conservation. With our{' '}
                  <strong>in-house manufacturing capabilities</strong>, we
                  design and produce rainwater harvesting modular structures and
                  filters, ensuring consistent quality and timely delivery.
                </p>
                ...
                <p>
                  ...
                  accumulated{' '}
                  <strong>
                    over 30 years of expertise in sustainable construction
                    methods.
                  </strong>{' '}
                  We are dedicated to delivering exceptional results and
                  providing personalized services tailored to meet each client's
                  unique requirements. Our primary approach to{' '}
                  <strong>
                    rainwater harvesting encompasses design, implementation,
                    maintenance, and monitoring, ensuring the long-term
