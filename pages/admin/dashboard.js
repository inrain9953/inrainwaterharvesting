...
import Blogs from '@/components/AddBlogs/Blogs'
          ...
          <div className='max-w-7xl mx-auto px-5 py-4 flex justify-between items-center'>
            ...
            <div className='flex items-center gap-4'>
              <button
                ...
                className='bg-sky-500 hover:bg-sky-600 transition text-white px-5 py-3 rounded-2xl flex items-center gap-2 font-semibold shadow-lg'
              >
                Add Blog
              </button>
