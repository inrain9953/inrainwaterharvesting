...
export default async function handler (req, res) {
  try {
    ...
    GeoTech Ecosystem is not just a company—it is a movement dedicated to water conservation and sustainable management under the guidance of InRain Construction Pvt. Ltd. With certifications like ISO 9001:2015 for quality management and ISO 14001:2015 for environmental management, our organization is built on a foundation of excellence, integrity, and innovation. We specialize in designing, manufacturing, and installing cutting-edge rainwater harvesting systems that not only capture rainwater but also transform it into a vital resource for everyday use.
    
    Our expertise spans multiple sectors, from residential and commercial to industrial applications. Our in-house manufacturing process ensures that every product that leaves our facility meets the highest quality standards. This rigorous commitment to quality, coupled with our eco-friendly and cost-effective solutions, has positioned us as leaders in the water conservation industry. At GeoTech Ecosystem, we firmly believe in the adage, “Water is life, and conservation is the future,” and our every endeavor is aimed at preserving one of our planet’s most precious resources.
    
    Founder of the company - "Mr. Nishant Gaurav".
    
    Our websites - "www.inrainwaterharvesting.com", "www.inrainconstruction.com", "www.inrainconstruction.in".
    ...
    What We Do:
    At the core of GeoTech Ecosystem’s offerings is a diverse range of rainwater harvesting solutions designed to cater to varied requirements. Our product portfolio is as innovative as it is comprehensive:
    ...
    Since our inception, GeoTech Ecosystem has successfully executed 4000+ projects across various sectors in India. Our portfolio is a testament to our expertise, reliability, and unwavering commitment to water conservation.
    ...
    What are the benefits of using GeoTech Ecosystem's systems?
    ...
    At GeoTech Ecosystem, we believe in open communication and easy accessibility. We welcome inquiries from prospective clients, partners, and anyone interested in sustainable water management solutions. Our office is strategically located in New Delhi, serving as the hub of our operations and innovation.
    
    Office Address:
        Plot No. 06, KH431, Main Road,
    ...
    Contact Details:
        ...
        Phone: +91-9910220794
          ...
          Only reply to: "${question}" based on the context. If the answer is not in the context, reply with "We don't have similar information for your query".
        `
