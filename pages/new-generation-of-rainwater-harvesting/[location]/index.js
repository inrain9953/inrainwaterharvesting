...
export default function NewGenerationOfRainwaterHarvesting ({ city, slug }) {
  const heading = 'New Generation of Rainwater Harvesting'
  const subheading = 'Rainwater Harvesting Company'
  const page = 'new-generation-of-rainwater-harvesting'
  const data = {
    title:
                  ...
                  <div className='space-y-4'>
                    ...
                    <div className='bg-white border space-y-3 border-slate-200 rounded-[32px] p-6 md:p-10 shadow-lg'>
                      <p className='text-gray-700 text-[15px] md:text-md leading-7 text-justify'>
                        ...
                        urban areas like Tezpur, implementing a rainwater
                        ...
                        inadequate rainfall. Therefore, adopting z can help
                      ...
                      <ul className='space-y-3'>
                        <li className='flex items-start gap-4'>
                          ...
                          <p className='text-gray-700 leading-7'>
                            ...
                            {heading} in {city.city} also aids in water
                            conservation. By capturing Rainwater, it can be used
                            for various non-potable purposes such as irrigation,
                            washing cars, flushing toilets, and cleaning. This
                            reduces the demand for freshwater and contributes to
                        ...
                        <li className='flex items-start gap-4'>
                          ...
                          <p className='text-gray-700 leading-7'>
                            ...
                            Implementing a {heading} in {city.city} offers
                            numerous benefits. Firstly, it promotes sustainable
                            water management by reducing the reliance on
                            groundwater and municipal water supply. This helps
                            conserve precious water resources and minimizes the
                            strain on existing water sources.
                          </p>
                        </li>
                        ...
                        <li className='flex items-start gap-4'>
                          ...
                          <p className='text-gray-700 leading-7'>
                            ...
                            Another advantage of Storm Water Management
                            Companies is the potential for cost savings.
                            Household and businesses can significantly reduce
                            their water bills by utilizing rainwater for
                            non-drinking purposes. Moreover, in the long run,
                            the initial investment in a rainwater harvesting
                            system can be recouped through these savings.
                          </p>
                        </li>
                      </ul>
