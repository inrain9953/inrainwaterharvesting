...
export default function PrefabricatedRainwaterHarvestingLocationPage ({
  city,
  slug
}) {
  const heading = 'Prefabricated Rainwater Harvesting'
  const subheading = 'Rainwater Harvesting System'
  const page = 'prefabricated-rainwater-harvesting'
  const data = {
                ...
                <div className='grid lg:grid-cols-[1.4fr_0.8fr] gap-10'>
                  ...
                  <div className='space-y-4'>
                    ...
                    <div className='bg-gradient-to-br from-sky-50 to-white border border-sky-100 rounded-[32px] p-5 md:p-10 shadow-lg'>
                      ...
                      <p className='text-gray-700 text-[15px] md:text-md leading-7 text-justify'>
                        {heading} in {city.city} offers numerous advantages,
                        including reduced water bills, decreased strain on
                        municipal water supplies, and increased self-sufficiency
                        in water usage. Additionally, it helps alleviate
                        stormwater runoff, reduces soil erosion, and supports
                    ...
                    <div className='bg-white border border-slate-200 rounded-[32px] p-6 md:p-10 shadow-lg'>
                      <h2 className='text-2xl md:text-3xl font-bold text-slate-900 mb-3'>
                        How Does {heading} Work in {city.city}?
                      </h2>
                    ...
                    <div className='bg-gradient-to-r from-sky-600 to-cyan-600 rounded-[32px] p-6 md:p-10 text-white shadow-2xl'>
                      <h2 className='text-2xl md:text-3xl font-bold mb-3'>
                        Best Choice for {heading} Solutions in {city.city}
                      </h2>
