...
const Products = () => {
  const data = {
    title: 'Our Products | GeoTech Ecosystem',
    desc: 'Looking for a reliable Rainwater Harvesting Products in India? GeoTech Ecosystem provide efficient solutions for sustainable water management and get Rooftop Rainwater Harvesting System in India.',
    keyword:
    ...
    ogTitle: 'Our Products | GeoTech Ecosystem',
    ogDescription:
      'Looking for a reliable Rainwater Harvesting Products in India? GeoTech Ecosystem provide efficient solutions for sustainable water management and get Rooftop Rainwater Harvesting System in India',
    ogUrl: 'https://www.inrainwaterharvesting.com/products',
    twittertitle: 'Our Products | GeoTech Ecosystem',
    twitterdescription:
      'Looking for a reliable Rainwater Harvesting Products in India? GeoTech Ecosystem provide efficient solutions for sustainable water management and get Rooftop Rainwater Harvesting System in India'
  }
  return (
          ...
          <div className='max-w-5xl mx-auto text-center'>
            ...
            <div className='mt-4 space-y-3 text-slate-600 text-[16px] md:text-md leading-7'>
              <p>
                ...
                conservation that aim to address the global water scarcity
                crisis. With a commitment to environmental sustainability and
                economic efficiency, GeoTech Ecosystem offers a range of
              ...
              <p>
                GeoTech Ecosystem offers a selection of water-efficient fixtures
                and appliances designed to minimize water consumption without
