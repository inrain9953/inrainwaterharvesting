...
export default function RWHForFloodMitigationLocationPage ({ city, slug }) {
  const heading = 'Rainwater Harvesting for Flood Mitigation'
  const subheading = 'Rainwater Harvesting System'
  const page = 'rainwater-harvesting-for-flood-mitigation'
  const data = {
    title:
