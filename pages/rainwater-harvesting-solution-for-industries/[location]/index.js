...
export default function RainwaterHarvestingSolutionForIndustriesLocationPage ({
  city,
  slug
}) {
  const heading = 'Rainwater Harvesting Solution for Industries'
  const subheading = 'Rainwater Harvesting Company'
  const page = 'rainwater-harvesting-solution-for-industries'
  const data = {
    title:
