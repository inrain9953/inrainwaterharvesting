...
export default function StormWaterManagementCompanyLocationPage ({
  city,
  slug
}) {
  const heading = 'Storm Water Management Company'
  const subheading = 'Rainwater Harvesting Company'
  const page = 'storm-water-management-company'
  const data = {
    title:
                      ...
                      <ul className='space-y-3'>
                        ...
                        <li className='flex items-start gap-4'>
                          ...
                          <p className='text-gray-700 leading-7'>
                            ...
                            Implementing a Storm Water Management Services
                            Provider in {city.city} offers numerous benefits.
                            Firstly, it promotes sustainable water management by
                            reducing the reliance on groundwater and municipal
                            water supply. This helps conserve precious water
                            resources and minimizes the strain on existing water
                            sources.
                          </p>
                        </li>
