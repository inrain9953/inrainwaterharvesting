                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-white border space-y-3 border-slate-200 rounded-[32px] p-6 md:p-10 shadow-lg">
                      <p className="text-gray-700 text-[15px] md:text-md leading-7 text-justify">
                        ...
                        crucial role in addressing water scarcity, especially in
                        urban and semi-urban areas where the demand for water is
                        continuously increasing. By capturing and reusing water,
                      ...
                      <p className="text-gray-700 text-[15px] md:text-md leading-7 text-justify">
                        ...
                        proper treatment, it can also be made suitable for
                        drinking. This reduces the strain on municipal water
                      ...
                      <p className="text-gray-700 text-[15px] md:text-md leading-7 text-justify">
                        ...
                        reliable water supply and building a sustainable future
